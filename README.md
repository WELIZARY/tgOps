...
Большинство команд можно вызывать без аргументов - бот покажет inline-кнопки выбора:
...
Если знаешь имя - пишешь сразу `/status k8s-c2`, кнопки не нужны. Меню удобно с телефона когда не помнишь точные имена.
